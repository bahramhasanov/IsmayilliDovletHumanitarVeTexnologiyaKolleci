    ...
    fetch(`/api/pdfapi?start=${start}&end=${end}&category=${subject}`, {
        ...
        .then(data => {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                <a style="font-weight: 600; font-size: 20px; line-height: 28px; text-align: center; letter-spacing: 0.15px; color: #000000;" target="_blank" href="${data[i]['slug']}/show"><p class="card-title text-dark">${data[i]['title'].substring(0, 10)}</p></a>
